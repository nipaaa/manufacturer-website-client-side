...
const Portfolio = () => {
    return (
        <div className='bg-base-200'>
            <h1 className="text-5xl text-center pt-8 text-primary font-bold">My Portfolio</h1>
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row">
                    <img src={portfolio} className="lg:max-w-lg sm:max-w-sm rounded-lg shadow-2xl" alt='' />
                    <div>
                        <h1 className="text-4xl text-secondary font-bold">Nipa Akter</h1>
